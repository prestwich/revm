...
## [42.1.0](https://github.com/prestwich/revm/compare/revm-database-interface-v42.0.0...revm-database-interface-v42.1.0) - 2026-07-30

### Added

- add async database fiber support ([#3709](https://github.com/prestwich/revm/pull/3709))
