...
## [42.0.2](https://github.com/prestwich/revm/compare/revm-precompile-v42.0.1...revm-precompile-v42.0.2) - 2026-07-30

### Other

- *(precompile)* use fused multi-miller loop for BLS12-381 pairing ([#3823](https://github.com/prestwich/revm/pull/3823))
- *(precompile)* correct read_fp canonical-check comment ([#3824](https://github.com/prestwich/revm/pull/3824))
